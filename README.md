...
### Main App (Android Phone)

| Screen | Description |
|--------|-------------|
| **📊 Main Dashboard** | See your BAC gauge, hydration, drinks, and tab all at a glance |
| **🍺 Log Drinks** | Quick-add beer, wine, cocktails, shots, or water in seconds |
| **📅 Calendar History** | Review your night history, sober streaks, and spending |
| **❤️ Health Insights** | Get personalized tips and hangover risk warnings |
| **📍 Live Share** | Check in to your venue and share your live location with friends |
| **🚕 Ride Safety** | One-tap summon for Uber, Lyft, or call your emergency contact |
| **👤 Profile & Settings** | Customize your weight, gender, emergency contact, and more |
| **🏠 Home Screen Widget** | Quick-add drinks straight from your home screen without opening the app |

### Wear OS Companion (Smartwatch)

| Screen | Description |
|--------|-------------|
| **⌚ Wear Dashboard** | See your BAC, sober countdown, and hydration on your wrist |
| **🍺 Quick Add Drink** | Add drinks with a single tap on your watch |
| **📍 Venue Check-In** | Check in to your bar from your wrist |
| **❤️ Health Vitals** | Monitor heart rate and steps synced from your watch sensors |
...
TipsyBuddy is an Android app (Android 8.0 and up), with a companion web tracker that works in any browser, and a Wear OS app for smartwatches.

- **Android app:** available in this repository — download the latest release APK and install on your phone.
- **Wear OS app:** companion app for your smartwatch — syncs your BAC, venue check-in, and quick-add buttons to your wrist.
